"""Tests for Magicseaweed api."""
import asyncio

import aiohttp
from custom_components.magicseaweed.api import (
    MagicseaweedApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = MagicseaweedApiClient("test", "test", async_get_clientsession(hass))
